    ...
    >
     {categories.map((item,idx)=>(
        ...
        onPress={()=>handleChangeCategory(item.category)}
         className={`flex flex-col items-start mr-4 py-2 px-4 rounded-full ${selectedCategory === item.category ? "bg-primary-300":"bg-primary-300/5 border border-primary-300/10"}`}
        >
